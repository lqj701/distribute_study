...
import chapter6.service.CustomCollapseCommand;
import chapter6.service.InstanceService;
...
public class InstanceController {
    ...
    @RequestMapping(value = "/feign/{servicdId}", method = RequestMethod.GET)
    ...
    public Instance getInstanceByServiceIdAsync(@PathVariable("serviceId") String serviceId)
    ...
    public Instance getInstanceByServiceIdObservable(@PathVariable("serviceId") String serviceId)
            throws ExecutionException, InterruptedException {
        logger.info("Get Instance by serviceId {}", serviceId);
