...
public class CustomCollapseCommand extends HystrixCollapser<List<Instance>, Instance, String> {
    ...
    @Override
    protected HystrixCommand<List<Instance>> createCommand(
            Collection<CollapsedRequest<Instance, String>> collapsedRequests) {
    ...
    @Override
    protected void mapResponseToRequests(List<Instance> batchResponse,
            Collection<CollapsedRequest<Instance, String>> collapsedRequests) {
        int count = 0;
